...
await writeFile('artifacts/wulftec-3d/Wulftec-360.html', `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Wulftec WCRT-200 · Interactive 3D</title><style>*{box-sizing:border-box}:root{--iag-reading-size:18px}body{font-size:18px;line-height:1.5;margin:0;padding:24px;background:#101010;color-scheme:dark;font-family:system-ui,sans-serif;color:#f2f2f2}header{max-width:1500px;margin:0 auto 20px}h1{font-size:26px;margin:0 0 8px}header p{margin:0;color:#bebebe}#root{max-width:1500px;margin:auto}.page-eyebrow{font-size:18px;letter-spacing:2px;font-weight:700}@media(max-width:600px){body{padding:12px}h1{font-size:22px}}${css}</style></head><body><header><h1>Wulftec WCRT-200</h1><p>Interactive reference model · 360° rotation & exploded assemblies</p></header><div id="root"></div><script>${js.replaceAll('</script', '<\\/script')}</script></body></html>`);
