...
- Baseline `npm run test:visual`: started in this session; completion still needs to be recorded. These baseline checks do not establish correctness of the future redesign or shared review workflow.
