...
describe('production documentation', () => {
  it('seeds only lines 1, 2 and 4, with equal high priority on 2 and 4 and separate survey candidates', () => {
    ...
    expect(pkg.assets.map(a => a.id)).toEqual(['FG-L4-MTN-001','L2-CC-001','LIEB-WULFTEC-A6882','LIEB-KOSME-TOPIIAD-L05358','LIEB-L2-CLIMAX-6759','LIEB-L2-CLIMAX-6759-CABINET']);
