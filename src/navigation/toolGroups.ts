...
export const toolGroups = [
  { id: 'everyday', label: 'Everyday tasks', description: 'Capture a note, find equipment information, or follow a documented connection.', ids: ['inventory', 'observation', 'field', 'evidence', 'relationships', 'cabinet', 'lines', 'documentation', 'maintenance', 'wulftec', 'help'] },
